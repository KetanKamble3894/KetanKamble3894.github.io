...
3. **Import the script as a runbook.** Take **[the script](../../scripts/autopilot-operations.md)**, import it into the Automation Account as a PowerShell 7 runbook, and publish it.
