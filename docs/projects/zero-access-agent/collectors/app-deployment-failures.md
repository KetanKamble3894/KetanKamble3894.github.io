...
Script: [`scripts/Collect-AppDeploymentFailures.ps1`](https://github.com/KetanKamble3894/zero-access-agent/blob/main/scripts/Collect-AppDeploymentFailures.ps1).
