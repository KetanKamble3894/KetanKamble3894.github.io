...
Script: [`scripts/Collect-LicenseComplianceCheck.ps1`](https://github.com/KetanKamble3894/zero-access-agent/blob/main/scripts/Collect-LicenseComplianceCheck.ps1).
